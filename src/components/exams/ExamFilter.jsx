import { categories, difficulties } from "./examsData";

export default function ExamFilter({ category, setCategory, difficulty, setDifficulty, search, setSearch }) {
  return (
    <div className="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 sm:flex-wrap sm:overflow-visible">
            <span className="text-xs text-gray-500 font-medium shrink-0">Difficulty:</span>
            {difficulties.map((d) => (
              <button key={d}
