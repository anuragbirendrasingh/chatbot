import { types, courseFilters } from "./governmentUniversitiesData";

export default function GovernmentUniversityFilter({ typeFilter, setTypeFilter, courseFilter, setCourseFilter, search, setSearch }) {
  return (
          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 sm:flex-wrap sm:overflow-visible">
            ...
            {types.map((t) => (
              <button key={t}
                ...
                {t === "State University (West Bengal)" ? "State Univ" : t}
              </button>
            ))}
          </div>
